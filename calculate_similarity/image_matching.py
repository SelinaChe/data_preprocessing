...
train_fc8 = np.loadtxt('feature_extraction/train_fc8_kevin_encode.txt')
#train_labels = np.loadtxt('feature_extraction/train_labels.txt')

test_fc8 = np.loadtxt('feature_extraction/test_fc8_kevin_encode.txt')
